<style>
 .widget-user-header{
     backgroung-postion:center center;
                        ...
                        <div class="tab-pane" id="activity">
                            ...
                            <div class="post">
                                <div class="user-block">
                                    <img class="img-circle img-bordered-sm" src="/../img/cover.jpg" alt="user image">
                                    <span class="username">
                          ...
                          <a href="#" class="float-right btn-tool"><i class="fas fa-times"></i></a>
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-6">
                                        <img class="img-fluid" src="/../img/cover.jpg" alt="Photo">
                                    </div>
                                    <!-- /.col -->
                                    <div class="col-sm-6">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <img class="img-fluid mb-3" src="/../img/cover.jpg" alt="Photo">
                                                <img class="img-fluid" src="/../img/cover.jpg" alt="Photo">
                                            </div>
                                            <!-- /.col -->
                                            <div class="col-sm-6">
                        ...
                        <div class="tab-pane active" id="settings">
                            <form class="form-horizontal">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" :class="{ 'is-invalid': form.errors.has('name') }" v-model="form.name" id="inputName" placeholder="Name">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="file" class="form-control" :class="{ 'is-invalid': form.errors.has('photo') }"  name="photo" @change="uploadPhoto" id="inputphoto" >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="password" class="form-control" v-model="form.password" id="password" name="password" placeholder="PassWord" :class="{ 'is-invalid': form.errors.has('password') }">
        ...
        methods: {
            ...
            uploadPhoto(e){
                ...
                if(file['size'] < 2111775) {
                    ...
                    swal.fire({
                        title: 'Ooops...',
                        text: 'You Are Trying to upload a large file .... Please select a one less than 2MB',
                        icon: 'warning'
                    })
                }
